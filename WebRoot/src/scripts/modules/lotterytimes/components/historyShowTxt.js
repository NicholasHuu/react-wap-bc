...
export function fiftle(code,index){
    ...
    if( /q4/.test(code) ){
        if(index < 4){return "choseEle";}
    }
    if( /h4/.test(code) ){
        if(index > 0){return "choseEle";}
    }
    if( /q3/.test(code) ){
        if(index < 3){return "choseEle";}
    }
    if( /z3/.test(code) ){
        if(index != 0 && index != 4){return "choseEle";}
    }
    if( /h3/.test(code) ){
        if(index > 1){return "choseEle";}
    }
    if( /q2/.test(code) ){
        if(index < 2){return "choseEle";}
    }
    if( /h2/.test(code) ){
        if(index > 2){return "choseEle";}
    }
    ...
    if( /lh/.test(code) ){
        if( /lh_lhh_wq/.test(code) ){
            if(index == 0 || index == 1){return "choseEle";}
        }
        if( /lh_lhh_wb/.test(code) ){
            if(index == 0 || index == 2){return "choseEle";}
        }
        if( /lh_lhh_ws/.test(code) ){
            if(index == 0 || index == 3){return "choseEle";}
        }
        if( /lh_lhh_wg/.test(code) ){
            if(index == 0 || index == 4){return "choseEle";}
        }
        if( /lh_lhh_qb/.test(code) ){
            if(index == 1 || index == 2){return "choseEle";}
        }
        if( /lh_lhh_qs/.test(code) ){
            if(index == 1 || index == 3){return "choseEle";}
        }
        if( /lh_lhh_qg/.test(code) ){
            if(index == 1 || index == 4){return "choseEle";}
        }
        if( /lh_lhh_bs/.test(code) ){
            if(index == 2 || index == 3){return "choseEle";}
        }
        if( /lh_lhh_bg/.test(code) ){
            if(index == 2 || index == 4){return "choseEle";}
        }
        if( /lh_lhh_sg/.test(code) ){
            if(index == 3 || index == 4){return "choseEle";}
        }
    }
    if( /wxwf/.test(code) ){
...
export function showTxt(code,list){
		let count = 0;
